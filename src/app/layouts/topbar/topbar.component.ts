...
export class TopbarComponent {
	...
	private loadUserDetails() {
		const user = this.pocketbase.pb.authStore.record;
		if (user) {
			this.currentUser = {
				company: (user as any)['expand']['company']['name'],
				email: user['email'],
				avatar: user['avatar'] ? this.pocketbase.pb.files.getUrl(user, user['avatar']) : 'assets/images/users/user-dummy-img.jpg',
